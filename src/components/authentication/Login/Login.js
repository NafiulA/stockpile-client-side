    ...
    return (
        ...
        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="password"
                    ...
                    <div className="flex justify-start items-center mb-6">
                        <button onClick={handleResetPassword} className="text-blue-600 hover:text-blue-900" type='button'>Forgot
                            password?</button>
                    </div>
      ...
      hover:bg-blue-600 hover:shadow-lg" value="log in" />
                    <p className="text-gray-800 mt-6 text-center">New to Stockpile? <button onClick={() => { navigate("/register") }}
